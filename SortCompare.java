...
Create an application to compare sort methods and return the time elapsed.

by Shubhra Bhardwaj, California Lutheran University

Original code by Robert Sedgewick & Kevin Wayne
from the textbook Algorithms, 4th Edition.
...
public class SortCompare {
    ...
    public static void main(String[] args) {
        ...
        int trials = Integer.parseInt(args[6]);
